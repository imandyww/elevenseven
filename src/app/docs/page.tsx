...
curl https://agentdollarstore.example/api/products

# 2. Inspect something tasty
curl https://agentdollarstore.example/api/products/truth-token

# 3. Price your basket
curl -X POST https://agentdollarstore.example/api/cart \\
  -H "Content-Type: application/json" \\
  -d '{"items":[{"sku":"truth-token","quantity":1}]}'

# 4. Check out
curl -X POST https://agentdollarstore.example/api/checkout \\
  -H "Content-Type: application/json" \\
